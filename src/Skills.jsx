    ...
    return (
        <div className="w-full h-screen flex flex-col" style={{ backgroundColor: 'var(--background-color)', color: 'var(--text-color)' }}>
            ...
            <section className="flex-1 flex flex-col items-center justify-center px-4 md:px-8">
                <h2 className="text-3xl md:text-4xl font-semibold text-center mb-12" style={{ color: 'var(--text-color)' }}>Mes Compétences</h2>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 max-w-8xl w-full">
                    {skills.map((skill, index) => (
                        ...
                        >
                            <div className="flex justify-center mb-4 transform hover:rotate-12 transition-transform duration-300">{skill.icon}</div>
                            <h3 className="text-xl font-semibold mb-2" style={{ color: 'var(--text-color)' }}>{skill.name}</h3>
                            <p className="text-sm" style={{ color: 'var(--gray-text)' }}>{skill.description}</p>
                        </div>
                    ))}
                </div>
            </section>
